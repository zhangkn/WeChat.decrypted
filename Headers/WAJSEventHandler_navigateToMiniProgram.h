...
- (void).cxx_destruct;
- (void)navigateToMiniProgramWitAppID:(id)arg1 userName:(id)arg2 debugMode:(unsigned long long)arg3 pagePath:(id)arg4 extraData:(id)arg5 pluginAppID:(id)arg6 navigationController:(id)arg7 sourceType:(unsigned int)arg8;

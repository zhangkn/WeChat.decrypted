...
@class FavSecurityLogic, FavoritesAsyncUploadMgr, FavoritesBatchDelMgr, FavoritesBatchGetMgr, FavoritesDownloadMgr, FavoritesItemDB, FavoritesRepairSvrDataLogic, FavoritesReportLogic, FavoritesSearchMgr, FavoritesSetting, FavoritesSyncMgr, FavoritesTagMgr, FavoritesUploadMgr, MyFavoritesDB, NSMutableArray, NSObject<OS_dispatch_semaphore>, NSString, WCScheduleLogicController;
